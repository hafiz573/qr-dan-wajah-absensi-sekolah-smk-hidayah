...
<div class="glass-card p-6" style="max-width: 600px; margin: 0 auto;">
    <div class="mb-6">
        <h2 style="font-size: 1.125rem; font-weight: 600;">Form Siswa Baru</h2>
        <p style="color: var(--text-muted); font-size: 0.875rem;">Masukkan informasi dasar siswa.</p>
    </div>
    ...
    <form action="{{ route('admin.students.store') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="nis" value="{{ old('nis') }}" class="glass-card" style="width: 100%; padding: 0.75rem 1rem; outline: none; border: 1px solid var(--glass-border);" placeholder="Contoh: 2024001" required>
        ...
        <div class="mb-4">
            ...
            <input type="text" name="name" value="{{ old('name') }}" class="glass-card" style="width: 100%; padding: 0.75rem 1rem; outline: none; border: 1px solid var(--glass-border);" placeholder="Nama Lengkap Siswa" required>
        ...
        <div class="mb-6">
            ...
            <input type="text" name="class" value="{{ old('class') }}" class="glass-card" style="width: 100%; padding: 0.75rem 1rem; outline: none; border: 1px solid var(--glass-border);" placeholder="Contoh: XII RPL 1" required>
